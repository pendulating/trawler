...
This page mirrors the upstream OpenAI docs as a reference. The
Trawler-specific architecture, upstream PrivacyLens parity details,
pipeline variants, config knobs, `items.parquet` schema, finalize
scripts, and `prepare_judge_batches.py` standalone utility all live in
**[`batch-judging.md`](batch-judging.md)**.
