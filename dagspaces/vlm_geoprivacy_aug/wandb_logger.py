"""W&B logger for the vlm_geoprivacy_aug dagspace.

The project matches vlm_geoprivacy_bench, so the augmented arm and the base
benchmark land in one dashboard. The ``dagspace_name`` tag separates them.
