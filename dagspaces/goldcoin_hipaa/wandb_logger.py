"""Wandb logger for the goldcoin_hipaa dagspace.

Thin wrapper around dagspaces.common.wandb_logger with
GoldCoin HIPAA-specific defaults.
"""
...
ensure_local_tmpdir("goldcoin_hipaa")
...
class WandbConfig(_WandbConfigBase):
    ...
    def from_hydra_config(cls, cfg, **kwargs) -> "WandbConfig":
        kwargs.setdefault("default_project", "goldcoin-hipaa")
        kwargs.setdefault("default_experiment_name", "GoldCoin-HIPAA")
