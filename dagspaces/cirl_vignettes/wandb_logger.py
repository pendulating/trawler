"""Wandb logger for the cirl_vignettes dagspace.

Thin wrapper around dagspaces.common.wandb_logger with
CIRL-Vignettes-specific defaults.
"""
...
ensure_local_tmpdir("cirl_vignettes")

_FULL_COLUMN_STAGES = frozenset({"llm_inference", "trajectory_inference"})


class WandbConfig(_WandbConfigBase):
    @classmethod
    def from_hydra_config(cls, cfg, **kwargs) -> "WandbConfig":
        kwargs.setdefault("default_project", "cirl-vignettes")
        kwargs.setdefault("default_experiment_name", "CIRL-Vignettes")
        ...
        kwargs.setdefault("dagspace_name", "cirl_vignettes")
